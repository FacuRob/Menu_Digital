...
const ProtectedRoute = ({ children, permiso, plataforma }: ProtectedRouteProps) => {
  const { isAuthenticated, isLoading, hasPermiso, isPlataforma, mustChangePassword } =
    useAuth();
  ...
  if ((permiso && !hasPermiso(permiso)) || (plataforma && !isPlataforma)) {
    return (
      <div
        style={{
          display: "flex",
